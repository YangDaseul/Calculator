package com.example.calclinearlayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    String operator, numButtonText, opButtonText;
    ...
    public void numButtonClick(View v) { //숫자
        ...
        numButtonText = numButton.getText().toString();
    ...
    public void opButtonClick(View v) { // 연산자
        ...
        opButtonText = opButton.getText().toString();
    ...
    public void perCentButtonClick(View v) {
        Button percentBtn = findViewById(v.getId());
        double data = Double.valueOf(resultText.getText().toString());
        data *= 0.01;
        resultText.setText(String.valueOf(data));

    }

    public void posNegButtonClick(View v) {
        Button posNegBtn = findViewById(v.getId());
        ...
        if (posNeg) { // 양수일 때
            ...
            resultText.setText(resultText.getText().toString().substring(1, resultText.getText().toString().length()));
            posNeg = !posNeg;
